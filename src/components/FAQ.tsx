...
const faqs = [
  {
    ...
    answer: "El proceso es muy sencillo: 1) Eliges un diseño de nuestro catálogo o envianos tu diseño. 2) Nos contactas por WhatsApp indicando la cantidad y ciudad. 3) nos envias un abono. 4) Te enviamos una simulación digital con los logos de tu equipo y patrocinadores. 5) Una vez aprobado, iniciamos producción."
  },
  {
  ...
  },
  {
    ...
    answer: "Utilizamos telas de alto rendimiento con tecnología antitranspirante que te mantienen seco y cómodo durante el juego. Además, cuentan con protección UV y costuras reforzadas de alta durabilidad. se acomoda a la temperatura ya que manejamos climas calidos como cartagena y climas frios como boyaca."
  },
  {
